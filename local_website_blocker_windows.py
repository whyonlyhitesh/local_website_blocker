...
def program_autostart_windows(auto_program):
        if int(auto_program) == 1:
            os.mkdir("C:\Windows\Program Files\local_website_blocking")
            shutil.copy(resource_path("windows_autostart_application"), "C:\Windows\Program Files\local_website_blocking\windows_autostart_application")
            add_to_startup("C:\Windows\Program Files\local_website_blocking\windows_autostart_application")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.optionmenu_var = customtkinter.StringVar(value="Windows")
        self.optionmenu_1 = customtkinter.CTkOptionMenu(self.scrollable_frame, dynamic_resizing=False, values=["Windows"], variable=self.optionmenu_var)
        self.optionmenu_1.grid(row=0, column=0, padx=20, pady=(20, 10))

        self.logo_label1 = customtkinter.CTkLabel(master=self.scrollable_frame, text="Also check out the Linux release!", font=customtkinter.CTkFont(size=12, weight="normal"))
        self.logo_label1.grid(row=10, column=0, padx=20, pady=(20, 10))
...
when you start your Windows computer or laptop?''', variable=self.check_var)
    ...
    def submit1(self):
        ...
        if user_choice == 1:
            program_autostart_windows(auto_program)
